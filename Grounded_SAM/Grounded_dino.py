...
BOX_TRESHOLD = 0.22  # not good for Heyward
TEXT_TRESHOLD = 0.06 # not good for Heyward
...
save_dir = r'/media/huan/HD16T/Research/street_image_mapping/Heyward_st_pano_thumnail_segmented'
...
img_file_list = glob(os.path.join('/media/huan/HD16T/Research/street_image_mapping/Heyward_st_pano_thumnail/', '*.jpg'))
...
# img_detect_results = detection_segment(img_file_list[:], save_img=False, save_dir=save_dir)
img_detect_results = detection_segment(img_file_list[:], save_img=True, save_dir=save_dir)
